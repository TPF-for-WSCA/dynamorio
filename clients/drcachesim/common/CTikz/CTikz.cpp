 ...
 *
 * @details Class to create Tikz files (Tikz ist kein Zeichenprogram) out of C array or
 * data vector. Pdf preview and latex code can also be generated.
 *
 */
...
// ========================================================================
void
CTikz::setTitle_vd(const std::string &f_title_s)
{
    m_title_s = f_title_s;
}
...
// ========================================================================
void
CTikz::setLegend_vd(const std::string &f_legend_s)
{
    m_legend_v.clear();
...
// ========================================================================
void
CTikz::addLegend_vd(const std::string &f_legend_s)
{
    if ("" != f_legend_s) {
...
// ========================================================================
void
CTikz::setLegendTitle_vd(const std::string &f_legendTitle_s)
{
...
// ========================================================================
void
CTikz::setXlabel_vd(const std::string &f_xLabel_s)
{
...
// ========================================================================
void
CTikz::setYlabel_vd(const std::string &f_yLabel_s)
{
...
// ========================================================================
void
CTikz::setLabel_vd(const std::string &f_xLabel_s, const std::string &f_yLabel_s)
{
...
// ========================================================================
void
CTikz::setData_vd(const double *f_dataX_pd, const double *f_dataY_pd, int f_size_i,
                  const std::string &f_comment_s, const std::string &f_color_s,
                  const std::string &f_plotStyle_s, const std::string &f_legend_s)
{
    m_dataSet_v.clear();
    m_legend_v.clear();
    addData_vd(f_dataX_pd, f_dataY_pd, f_size_i, f_comment_s, f_color_s, f_plotStyle_s,
               f_legend_s);
}
...
// ========================================================================
void
CTikz::setData_vd(const std::vector<double> &f_dataX_v,
                  const std::vector<double> &f_dataY_v, const std::string &f_comment_s,
                  const std::string &f_color_s, const std::string &f_plotStyle_s,
...
// ========================================================================
void
CTikz::setData_vd(const std::vector<std::pair<double, double>> &f_data_v,
                  const std::string &f_comment_s, const std::string &f_color_s,
                  const std::string &f_plotStyle_s, const std::string &f_legend_s)
{
    m_dataSet_v.clear();
...
// ========================================================================
void
CTikz::setData_vd(const gType_TIKZ_DataSetEntry_st &f_dataSetEntry_st,
                  const std::string &f_legend_s)
{
    m_dataSet_v.clear();
...
// ========================================================================
void
CTikz::addData_vd(const double *f_dataX_pd, const double *f_dataY_pd, int f_size_i,
                  const std::string &f_comment_s, const std::string &f_color_s,
                  const std::string &f_plotStyle_s, const std::string &f_legend_s)
{
    if ((0 == f_dataX_pd) || (0 == f_dataY_pd)) {
        ...
        for (int l_k_i = 0; l_k_i < f_size_i; ++l_k_i) {
            std::pair<double, double> l_dataEntry_c =
                std::make_pair(*f_dataX_pd, *f_dataY_pd);
...
// ========================================================================
void
CTikz::addData_vd(const std::vector<double> &f_dataX_v,
                  const std::vector<double> &f_dataY_v, const std::string &f_comment_s,
                  const std::string &f_color_s, const std::string &f_plotStyle_s,
                  const std::string &f_legend_s)
{
    ...
    if (f_dataX_v.size() != f_dataY_v.size()) {
        ...
        l_msg_ss << "Data sizes must be the same. dataX.size()=" << f_dataX_v.size()
                 << ", dataY.size()=" << f_dataY_v.size() << std::endl;
        throw CException(l_msg_ss);
    } else {
        for (size_t l_k_i = 0; l_k_i < f_dataX_v.size(); ++l_k_i) {
            std::pair<double, double> l_dataEntry_c =
                std::make_pair(f_dataX_v.at(l_k_i), f_dataY_v.at(l_k_i));
            l_tmp_v.push_back(l_dataEntry_c);
        }
    }
    addData_vd(l_tmp_v, f_comment_s, f_color_s, f_plotStyle_s, f_legend_s);
...
// ========================================================================
void
CTikz::addData_vd(const std::vector<std::pair<double, double>> &f_data_v,
                  const std::string &f_comment_s, const std::string &f_color_s,
                  const std::string &f_plotStyle_s, const std::string &f_legend_s)
{
    if (f_data_v.empty()) {
...
// ========================================================================
void
CTikz::addData_vd(const gType_TIKZ_DataSetEntry_st &f_dataSetEntry_st,
                  const std::string &f_legend_s)
{
    m_dataSet_v.push_back(f_dataSetEntry_st);
    addLegend_vd(f_legend_s);
...
// ========================================================================
void
CTikz::setLegendStyle_vd(const std::string &f_legendStyle_s)
{
...
// ========================================================================
void
CTikz::setWidth_vd(const std::string &f_width_s)
{
    m_width_s = f_width_s;
}
...
// ========================================================================
void
CTikz::setHeight_vd(const std::string &f_height_s)
{
...
// ========================================================================
void
CTikz::createTikzFile_vd(const std::string &f_filename_s)
{
...
// ========================================================================
void
CTikz::createTikzFileHist_vd(const std::string &f_filename_s, int f_bins_i,
                             double f_dataMin_d, double f_dataMax_d)
{
...
// ========================================================================
void
CTikz::createSecondAxisCode_vd(std::string &f_secondAxisCode_s)
{
    ...
    for (std::vector<std::string>::const_iterator l_settings_it =
             m_additionalSettings_v.begin();
    ...
    for (std::size_t l_k_i = 0; l_k_i < m_legend_v.size() - m_dataSet_v.size(); ++l_k_i) {
        l_Code_ss << "\\addlegendimage{/pgfplots/refstyle=addPlotLabel_" << m_id_s << "_"
                  << l_k_i << "}" << std::endl;
        l_Code_ss << "\\addlegendentry{" << m_legend_v.at(l_k_i) << "};" << std::endl;
    }
    std::size_t l_legendIdx_i = m_dataSet_v.size();
    for (std::vector<gType_TIKZ_DataSetEntry_st>::const_iterator l_dataSetEntry_it =
             m_dataSet_v.begin();
         l_dataSetEntry_it != m_dataSet_v.end(); ++l_dataSetEntry_it) {
        l_Code_ss << "\\addplot [color=" << l_dataSetEntry_it->color_s << ","
                  << l_dataSetEntry_it->plotStyle_s << "]" << std::endl;
        l_Code_ss << "  table[row sep=crcr]{%" << std::endl;
        for (std::vector<std::pair<double, double>>::const_iterator l_data_it =
                 l_dataSetEntry_it->data_v.begin();
             l_data_it != l_dataSetEntry_it->data_v.end(); ++l_data_it) {
            l_Code_ss << l_data_it->first << "\t" << l_data_it->second << "\\\\"
                      << std::endl;
        }
        l_Code_ss << "};" << std::endl;
        if (l_legendIdx_i < m_legend_v.size()) {
            l_Code_ss << "\\addlegendentry{" << m_legend_v.at(l_legendIdx_i) << "};"
                      << std::endl;
            ++l_legendIdx_i;
        }
    }
    l_Code_ss << std::endl;
    for (std::vector<std::string>::iterator l_command_it =
             m_additionalsCommands_v.begin();
         l_command_it != m_additionalsCommands_v.end(); ++l_command_it) {
...
// ========================================================================
void
CTikz::createTikzPdf_vd(const std::string &f_filenameTikz_s)
{
...
// ========================================================================
void
CTikz::createTikzPdfHist_vd(const std::string &f_filenameTikz_s, int f_bins_i,
                            double f_dataMin_d, double f_dataMax_d)
{
...
// ========================================================================
void
CTikz::setRangeX_vd(double f_minVal_d, double f_maxVal_d)
{
...
// ========================================================================
void
CTikz::setRangeY_vd(double f_minVal_d, double f_maxVal_d)
{
...
// ========================================================================
void
CTikz::setAdditionalSettings_vd(const std::string &f_settings_s)
{
...
// ========================================================================
void
CTikz::addAdditionalSettings_vd(const std::string &f_settings_s)
{
...
// ========================================================================
void
CTikz::setAdditionalCommands_vd(const std::string &f_command_s)
{
    m_additionalsCommands_v.clear();
...
// ========================================================================
void
CTikz::addAdditionalCommands_vd(const std::string &f_command_s)
{
...
// ========================================================================
void
CTikz::setAdditionalCommandsAfterBeginTikzePicture_vd(const std::string &f_command_s)
{
    m_additionalsCommandsAfterBeginTikzPicture_v.clear();
...
// ========================================================================
void
CTikz::addAdditionalCommandsAfterBeginTikzePicture_vd(const std::string &f_command_s)
{
...
// ========================================================================
void
CTikz::addNode_vd(double f_posX_d, double f_posY_d, const std::string &f_text_s,
                  const std::string &f_color_s, const std::string &f_anchor_s,
                  double f_rotate_d, const std::string &f_font_s)
{
...
// ========================================================================
void
CTikz::setSecondAxisCode_vd(const std::string &f_secondAxisCode_s)
{
    m_secondAxisCode_s = f_secondAxisCode_s;
}

// ========================================================================
// set addional cammands which are only used for PDF preview generation, i.e. for latex
// code (old latex commands are cleared)
// ========================================================================
void
CTikz::setAdditionalLatexCommands_vd(const std::string &f_additionalLatexCommands_s)
{
    m_additionalLatexCommands_s = f_additionalLatexCommands_s;
}

// ========================================================================
// add addional cammands which are only used for PDF preview generation, i.e. for latex
// code
// ========================================================================
void
CTikz::addAdditionalLatexCommands_vd(const std::string &f_additionalLatexCommands_s)
{
    m_additionalLatexCommands_s += "\n";
    m_additionalLatexCommands_s += f_additionalLatexCommands_s;
}
...
// ========================================================================
void
CTikz::setAuthor_vd(const std::string &f_author_s)
{
...
// ========================================================================
void
CTikz::setInfo_vd(const std::string &f_info_s)
{
    m_info_s = f_info_s;
}
...
// ========================================================================
void
CTikz::m_createTikzFile_vd(const std::string &f_filename_s, bool f_createHist_b,
                           int f_bins_i /* = 0 */, double f_dataMin_d /* = 0 */,
                           double f_dataMax_d /* = 0 */)
{
    ...
    for (std::vector<std::string>::iterator l_cmd_it =
             m_additionalsCommandsAfterBeginTikzPicture_v.begin();
         l_cmd_it != m_additionalsCommandsAfterBeginTikzPicture_v.end(); ++l_cmd_it) {
    ...
    for (std::vector<gType_TIKZ_DataSetEntry_st>::const_iterator l_dataSetEntry_it =
        ...
        for (std::vector<std::pair<double, double>>::const_iterator l_data_it =
                 l_dataSetEntry_it->data_v.begin();
             l_data_it != l_dataSetEntry_it->data_v.end(); ++l_data_it) {
            l_tikz_ss << l_data_it->first << "\t" << l_data_it->second << "\\\\"
                      << std::endl;
        }
        l_tikz_ss << "};" << std::endl;
        l_tikz_ss << "\\label{addPlotLabel_" << m_id_s << "_" << l_IdCtr_i++ << "}"
                  << std::endl;
        if ("" != m_legendTitle_s && !l_legendTitleSet_b) {
            l_tikz_ss << "\\addlegendentry{\\hspace{-.6cm}" << m_legendTitle_s << "};"
                      << std::endl;
            l_legendTitleSet_b = true;
        }
        if (l_legendIdx_i < (int)m_legend_v.size()) {
            l_tikz_ss << "\\addlegendentry{" << m_legend_v.at(l_legendIdx_i) << "};"
                      << std::endl;
            ++l_legendIdx_i;
        }
    }
    ...
    l_tikz_ss << std::endl;
    for (std::vector<std::string>::iterator l_commands_it =
             m_additionalsCommands_v.begin();
         l_commands_it != m_additionalsCommands_v.end(); ++l_commands_it) {
...
// ========================================================================
void
CTikz::m_createPdf_vd(const std::string &f_filenameTikz_s)
{
    ...
    if (l_file_c) {
        ...
        // user defined colors are colors which are used in the tikz file and which have
        // to be defined when creating a pdf file with this class CTikz
        ...
        // add user defined definitions, symbols etc. to additionalLatexCommands, here an
        // example as default user defined definitions or symbols are definitions which
        // are used in the tikz file. But they have to be definied in
        // additionalLatexCommand to make it possible to create a pdf file with this class
        // CTikz
        ...
        l_file_c << "  \\input{" << m_trimFilename_s(f_filenameTikz_s) << "}"
                 << std::endl;
    ...
    l_Cmd_ss << "/usr/bin/bash -c \"CURR=$(pwd) &&\ncd " << l_path_s
             << " &&\n/usr/bin/pdflatex ";
    l_Cmd_ss << "--output-directory " << l_path_s;
    l_Cmd_ss << " -shell-escape -interaction=nonstopmode -file-line-error "
             << m_trimFilename_s(l_filenameTex_s) << " > /dev/null &&\ncd $CURR\"";
    // l_Cmd_ss << "pdflatex ";
    // l_Cmd_ss << "--output-directory " << l_path_s;
    // l_Cmd_ss << " " << m_trimFilename_s(l_filenameTex_s);
    // l_Cmd_ss << " >/dev/null";
    std::cout << "EXECUTING: " << l_Cmd_ss.str().c_str() << std::endl;
...
// ========================================================================
std::string
CTikz::m_trimFilename_s(const std::string &f_filename_s)
{
...
// ========================================================================
bool
CTikz::m_fileExist_b(const std::string &f_filename_s)
{
